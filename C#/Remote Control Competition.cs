...
public static class TestTrack
{
    ...
    public static List<ProductionRemoteControlCar> GetRankedCars(ProductionRemoteControlCar prc1,
        ProductionRemoteControlCar prc2) => (prc2.NumberOfVictories > prc1.NumberOfVictories) ? new List<ProductionRemoteControlCar> { prc1, prc2 } : new List<ProductionRemoteControlCar> { prc2, prc1 };
}